...
local_source_repo_path = 'C:\User\saldrin.b.carlos\git\Repo_DC01'         # Local path for source repo
...
target_file_path = 'C:\Users\aldrin.b.carlos\git\Repo_DC02\ContentFile.txt'               # Path to save the file in the target repo
